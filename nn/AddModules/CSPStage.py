...
class BasicBlock_3x3_Reverse(nn.Module): 
    def __init__(self, ch_in, ch_hidden_ratio, ch_out, act='relu'): 
        ...
        self.conv2 = RepConv2(ch_in, ch_hidden, 3, act=act) 
...
# 这一行是为了让 torch.load 能够通过 "RepConv" 找到 "RepConv2"
# 但在 Python 的类型检查中，RepConv2 已经不再是原来的 RepConv 类了
RepConv = RepConv2